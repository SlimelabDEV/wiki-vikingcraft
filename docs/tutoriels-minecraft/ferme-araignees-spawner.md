...
1. Abaissez le sol sous le spawner.
2. Placez des courants d'eau qui convergent vers un canal.
3. Donnez au canal assez de largeur pour éviter les blocages.
4. Réduisez progressivement l'espace près de la chambre de mort.
5. Installez la collecte sous les feux de camp ou derrière la zone de frappe.
6. Fermez tous les passages par lesquels une araignée pourrait atteindre le joueur.
...
Le trajet est trop lent ou la salle contient des angles où elles peuvent grimper. Modifiez les courants et réduisez les surfaces verticales inutiles.

### Elles se bloquent dans le canal

Élargissez le passage et évitez les virages brusques. Les dimensions prévues pour les zombies ne conviennent pas toujours.

### La ferme s'arrête après quelques minutes
