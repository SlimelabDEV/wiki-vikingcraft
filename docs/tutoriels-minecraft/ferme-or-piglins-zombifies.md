...
Elle utilise de grandes plateformes dans un biome adapté. Les piglins zombifiés sont attirés ou provoqués afin de rejoindre une zone de chute.
...
- Des œufs de tortue protégés pour attirer certaines créatures
- Des trappes
- Des entonnoirs et de grands coffres
- Un système de tri
...
3. Guidez les créatures vers des ouvertures centrales.
4. Utilisez une chute pour les affaiblir.
5. Protégez le joueur dans une chambre de frappe.
6. Triez l'or et la chair putréfiée à la sortie.
7. Ajoutez un arrêt d'urgence ou un accès permettant de vider la ferme.
...
Contrôlez le biome, la distance avec le joueur et les surfaces concurrentes. Plusieurs joueurs présents dans le Nether peuvent aussi modifier le rendement.

### La zone de frappe déborde

Augmentez la vitesse d'élimination et la capacité de stockage. Une ferme à or peut produire beaucoup plus d'objets que prévu.

### Des piglins apparaissent ailleurs
