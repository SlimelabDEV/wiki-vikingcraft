...
- Préparez des blocs solides, de la nourriture et un bon équipement.
- Gardez du lait pour supprimer un effet dangereux si nécessaire.
- Testez les règles du serveur sur une petite installation.
...
- Un village minimal avec un villageois et un lit
- Une plateforme où les vagues peuvent apparaître
- Un moyen de canaliser les illageois
- Une chambre de mort ou de frappe
- Des entonnoirs et un stockage important
- Un accès protégé pour le joueur
...
3. Entrez dans la zone du village de la ferme.
4. Attendez la conversion en Présage de raid et le début du raid.
5. Laissez les vagues rejoindre la chambre de collecte.
6. Vérifiez la fin complète du raid avant de relancer un cycle.
...
Des lits ou des villageois proches déplacent probablement le centre utilisé. Éloignez l'installation et retirez les points de village involontaires.

### Une vague reste introuvable

Un illageois a pu apparaître dans une grotte, sur une rive ou derrière un relief. Aplanissez et sécurisez toute la zone d'apparition.

### Aucun totem n'est récupéré
