...
:::note
📌 Le premier trieur le plus proche de la source d'approvisionnement ne trie pas les objets. Ne paniquez pas ! Si cela arrive, cassez et reposez l'entonnoir de tri jusqu'à ce que les items descendent d'eux-mêmes dans cet entonnoir en replaçant bien les items renommés.
...
- Il est tout à fait normal qu'une quantité plus ou moins importante d'items à trier reste en permanence dans l'entonnoir de tri (environ 40). Dès l'arrivée des prochains items dedans, le surplus sera libéré pour arriver dans le stockage.
